...
static struct {
	...
	{ "/api/bulklists",                         "/{list}",                    api_list,                              { API_PARSE_JSON, 0                         }, true,  HTTP_GET | HTTP_PUT | HTTP_DELETE },
	{ "/api/bulklists",                         "",                           api_list,                              { API_PARSE_JSON, 0                         }, true,  HTTP_POST },
	{ "/api/bulklists:batchDelete",             "",                           api_list,                              { API_PARSE_JSON | API_BATCHDELETE, 0       }, true,  HTTP_POST },
