...
enum gravity_list_type {
    ...
    GRAVITY_BULKLISTS,
    GRAVITY_BULKLISTS_ADLISTS_BLOCK,
    GRAVITY_BULKLISTS_ADLISTS_ALLOW,
    GRAVITY_BULKLISTS_DOMAINLIST_ALLOW_EXACT,
    GRAVITY_BULKLISTS_DOMAINLIST_ALLOW_REGEX,
    GRAVITY_BULKLISTS_DOMAINLIST_DENY_EXACT,
    GRAVITY_BULKLISTS_DOMAINLIST_DENY_REGEX,
} __attribute__ ((packed));
...
enum adlist_type {
	BULKLIST_ADLISTS_BLOCK = 0,
	BULKLIST_ADLISTS_ALLOW,
	BULKLIST_DOMAINLIST_DENY_EXACT,
	BULKLIST_DOMAINLIST_ALLOW_EXACT,
	BULKLIST_DOMAINLIST_DENY_REGEX,
	BULKLIST_DOMAINLIST_ALLOW_REGEX,
} __attribute__ ((packed));
